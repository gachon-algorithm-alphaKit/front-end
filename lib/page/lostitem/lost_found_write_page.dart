...
class _LostFoundWritePageState extends State<LostFoundWritePage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(_isEditMode ? '신고 내용이 수정되었습니다.' : '분실물 신고가 접수되었습니다.')));
        Navigator.pop(context);
      }
    } finally {
                        ...
                        GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(12),
                              border: Border.all(color: _isAnonymous ? Colors.redAccent : Colors.grey.shade300, width: _isAnonymous ? 1.5 : 1.0),
                            ),
                            child: Row(
                              children: [
                                AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(color: _isAnonymous ? Colors.redAccent : Colors.grey.shade400, width: 1.5),
                                  ),
                                  child: _isAnonymous ? const Icon(Icons.check_rounded, color: Colors.white, size: 15) : null,
                                ),
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      '익명으로 작성하기',
                                      style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: _isAnonymous ? Colors.redAccent : Colors.black87),
                                    ),
                                    const SizedBox(height: 2),
                                    Text('선택 시 작성자 정보가 공개되지 않습니다', style: TextStyle(fontSize: 11, color: Colors.grey.shade500)),
                                  ],
                                ),
                                const Spacer(),
                                if (_isAnonymous)
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  _status ? '주인 찾음' : '보관중',
                                  style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: _status ? Colors.grey.shade700 : Colors.orange.shade700),
                                ),
                                Switch(
                                  value: _status,
