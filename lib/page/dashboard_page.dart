...
import 'game/widget/topic_banner_widget.dart';
...
class MainDashboardPage extends StatefulWidget {
  ...
  const MainDashboardPage({super.key, this.initialProfile, this.initialProfileImage});
  @override
...
class _MainDashboardPageState extends State<MainDashboardPage> {
  ...
  static const _cards = [
    ...
    {'title': '밸런스 게임', 'sub': '흑백 논란 실시간 토론', 'icon': Icons.how_to_vote_rounded, 'color': Colors.deepPurple},
  ];

  Color _cardColor(int i) {
    final colors = [Colors.blueAccent, Colors.amber.shade800, Colors.green.shade600, Colors.redAccent, Colors.teal.shade600, Colors.deepPurple];
    return colors[i];
  }
